            ...
            <section id="shipping-address" style="margin-bottom:100px;margin-top:-10px">
                <h2 class="border h1">收货地址</h2>
                    ...
                    <div class="row field-row" style="margin-top:10px">
                        <div class="col-xs-12">
                            <input class="le-radio big address" type="radio" name="addressid" value="<?php echo $address['addressid'] ?>"  />
            ...
            <div class="billing-address" style="display:none;">
                ...
                <?php ActiveForm::begin([
                    ...
                    <div class="row field-row">
                        <div class="col-xs-12 col-sm-6">
                            <label>地址*</label>
                            <input class="le-input" data-placeholder="例如：开封市金明区" name="address1" >
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <label>&nbsp;</label>
                            <input class="le-input" data-placeholder="例如：金明大道" name="address2" >
                        </div>
                    </div><!-- /.field-row -->
