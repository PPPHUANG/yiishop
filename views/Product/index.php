            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4 no-margin">
                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>" class="thumb-holder">
                        <img alt="" src="<?php echo $pro['pics'] ?>-coversmall"/>
                    </a>
                </div>
...
<?php foreach($tui as $pro): ?>
        <li class="sidebar-product-list-item">
            <div class="row">
                <div class="col-xs-4 col-sm-4 no-margin">
                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>" class="thumb-holder">
                    <img alt="" src="<?php echo $pro['pics'] ?>-covertowsmall"/>
                    </a>
                </div>
                <div class="col-xs-8 col-sm-8 no-margin">
                <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>"><?php echo $pro['title'] ?></a>
...
<?php foreach($hot as $pro): ?>
        <div class="no-margin carousel-item product-item-holder hover size-medium">
            <div class="product-item">
                ...
                <div class="image">
                <img alt="" src="<?php echo $pro['cover'] ?>-covertowsmall" />
                </div>
                <div class="body">
                    <div class="title">
                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>"><?php echo $pro['title'] ?></a>
                        ...
                        <div class="row">
                            ...
                            <div class="no-margin col-xs-12 col-sm-3 price-area">
                                <div class="right-clmn">
                                    ...
                                    <a class="btn-add-to-wishlist" href="<?php echo yii\helpers\Url::to(['cart/add', 'productid' => $pro['productid']]) ?>">加入购物车</a>
                                </div>
                            </div><!-- /.price-area -->
                        </div><!-- /.row -->
                    </div><!-- /.product-item -->
