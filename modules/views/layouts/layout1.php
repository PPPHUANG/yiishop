...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            ...
            <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">易货小铺 - 后台管理</a>
        ...
        <ul id="dashboard-menu">
			...
			<li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="<?php echo yii\helpers\Url::to(['product/add'])?>">加入商品</a></li>
                </ul>
            </li>
			<li>
                <a class="dropdown-toggle" href="#">
