                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                                ...
                                <?php
                                    ...
                                    echo $form->field($model, 'pics')->fileInput(['class' => 'span9']);
                                ?>
                                <?php if(!empty($model->pics)): ?>
                                    <img src="<?php echo $model->pics;?>">
                                    <a href="<?php echo yii\helpers\Url::to(['product/removepic', 'key' => '', 'productid' => $model->productid]) ?>"></a>
                                <?php endif;?>
                                <hr>
